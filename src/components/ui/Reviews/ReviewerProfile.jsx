...
export const ReviewerProfile = ({user}) => {

    if (!user) {
        return <Error type='review'/>;
    }
    ...
    return (
        <section className="container w-full text-white">
            <div className="container w-full sm:px-6 py-8">
                ...
                <div className="rounded-3xl mt-[2rem] border border-neutral-800 bg-gradient-to-br from-neutral-900 via-neutral-900/90 to-neutral-950 p-6 md:p-8 shadow-[0_20px_60px_-32px_rgba(0,0,0,0.6)]">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <button className="cursor-pointer px-4 py-2 rounded-[10px] bg-white text-black font-medium hover:scale-[1.01] transition">Message</button>
                            <button className="cursor-pointer px-4 py-2 rounded-[10px] border border-neutral-700 text-gray-100 hover:border-white transition">Follow</button>
                            <button className="cursor-pointer p-2 rounded-[10px] border border-neutral-800 text-gray-300 hover:text-white hover:border-white transition" aria-label="Share profile">
