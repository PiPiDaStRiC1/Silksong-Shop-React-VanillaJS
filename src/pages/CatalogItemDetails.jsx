...
export const CatalogItemDetails = () => {
    ...
    if (!product) {
        return (
            <section className="container w-full px-6 py-10 text-white">
                <nav className="text-sm text-gray-400 mb-6">
                    <Link to="/" className="hover:text-gray-200">Home</Link>
                    <span className="mx-2">/</span>
                    <Link to="/catalog" className="hover:text-gray-200">Catalog</Link>
                    <span className="mx-2">/</span>
                    <span className="text-gray-200">Not found</span>
                </nav>
            ...
            <div className="container w-full px-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                        ...
                        <span className="px-2 py-1 rounded-full bg-neutral-800 border border-neutral-700">In stock</span>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="px-5 py-2 rounded-[10px] border border-white text-white hover:bg-white hover:text-black transition-all cursor-pointer">Add to Cart</button>
